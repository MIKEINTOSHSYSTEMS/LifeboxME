...
HTML;
                ...
                $zip->addFile($this->view->theme->getPath('assets/css/bootstrap.min.css'), 'css/bootstrap.min.css');
                if ($formModel->text_direction === 'rtl') {
                    $zip->addFile($this->view->theme->getPath('assets/css/bootstrap-rtl.min.css'), 'css/bootstrap-rtl.min.css');
                }
                $zip->addFile($this->view->theme->getPath('assets/css/public.min.css'), 'css/public.min.css');
                $zip->close();
