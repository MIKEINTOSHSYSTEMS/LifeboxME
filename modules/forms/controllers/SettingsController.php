...
class SettingsController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'rules' => [
                    ['actions' => ['site', 'form', 'open-source-licenses', 'logo-delete'], 'allow' => true, 'roles' => ['configureSite']],
    ...
    public function actionOpenSourceLicenses()
    {
        $this->layout = 'admin'; // In @app/views/layouts
        return $this->render('open-source-licenses', [
        ]);
    }
