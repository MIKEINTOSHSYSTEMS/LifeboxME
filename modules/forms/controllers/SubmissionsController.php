...
use app\components\actions\FormSubmissionCreateAction;
use app\components\actions\FormSubmissionUpdateAction;
...
class SubmissionsController extends ActiveController
{
    ...
    public function actions()
    {
        ...
        $actions['create'] = [
            'class' => FormSubmissionCreateAction::class,
        ...
        $actions['update'] = [
            'class' => FormSubmissionUpdateAction::class,
            'modelClass' => $this->modelClass,
            'checkAccess' => [$this, 'checkAccess'],
            'scenario' => $this->createScenario,
        ];
