...
/* @var $searchModel app\modules\addons\modules\postgres\models\PostgresSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'PostgreSQL');
...
$gridColumns = [
    ...
    [
        ...
        'format' => 'raw',
        'value' => function ($model) {
            $events = EventHelper::supportedFormEvents();
            return $events[$model->event] ?? null;
        },
        'filter' => Html::activeDropDownList(
            $searchModel,
            'event',
            EventHelper::supportedFormEvents(),
            ...
            <div class="col-md-12">
                <?= GridView::widget([
                    ...
                    'panel' => [
                        ...
                        'heading' => Yii::t('app', 'PostgreSQL')
                            . ' <small class="ms-3 text-muted d-none d-sm-inline">'
                            . Yii::t('app', 'Saving form data to a PostgreSQL database')
                            . ' </small>',
                                ...
                                Html::a(
                                    ...
                                    Html::a(
                                        ...
                                        [
                                            ...
                                            'title' => Yii::t(
                                                'app',
                                                'Archive your new form submissions in an existing PostgreSQL database table. After you set up this integration, every time there is a new form submission, a new row will be inserted in a PostgreSQL table.'
                                            ),
