...
/**
 * PostgresSearch represents the model behind the search form about `app\modules\addons\modules\postgres\models\Postgres`.
 */
class PostgresSearch extends Postgres
{
    ...
    public function search($params)
    {
        ...
        if (isset($this->updated_at) && !empty($this->updated_at)) {
            ...
            $query->andFilterWhere(['between', '{{%addon_postgres}}.updated_at', $startAt, $endAt]);
        }
        ...
        $query->andFilterWhere([
            ...
            '{{%addon_postgres}}.status' => $this->status,
            '{{%addon_postgres}}.event' => $this->event
        ]);

        $query
            ->andFilterWhere(['like', '{{%addon_postgres}}.name', $this->name])
        ...
        $query->andFilterWhere(['{{%addon_postgres}}.form_id' => $formIds]);
