...
require_once("include/training_attendance_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.training_attendance" );
