...
require_once("include/lbapt_beginnings_fund_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.lbapt_beginnings_fund" );
