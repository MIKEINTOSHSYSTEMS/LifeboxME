...
require_once("include/unit_of_measurement_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.unit_of_measurement" );
