...
require_once("include/clean_cut_implementation_summary_view_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.clean_cut_implementation_summary_view" );
