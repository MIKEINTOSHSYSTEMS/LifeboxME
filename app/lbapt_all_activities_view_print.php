...
require_once("include/lbapt_all_activities_view_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.lbapt_all_activities_view" );
