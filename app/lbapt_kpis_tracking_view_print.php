...
require_once("include/lbapt_kpis_tracking_view_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.lbapt_kpis_tracking_view" );
