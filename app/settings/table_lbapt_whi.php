...
$runnerTableSettings['public.lbapt_whi'] = array(
		...
		'strategic_area_id' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'lookupWhere' => 'strategic_area_id = 13',
					'fileMaxNumber' => 1,
					'fileThumbnailField' => 'th',
					'timeConvention' => 1 
				) 
...
FROM "public".lbapt_whi',
	...
	created_at,
	updated_at',
		'fromListSql' => 'FROM "public".lbapt_whi',
		'orderBySql' => '',
		'tailSql' => '' 
	),
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.lbapt_whi'] = array(
	'tableCaption' => 'Lbapt Whi',
	'fieldLabels' => array(
		'whi_id' => 'WHI-ID',
