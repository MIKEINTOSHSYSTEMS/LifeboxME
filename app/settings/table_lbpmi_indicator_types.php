...
$runnerTableSettings['public.lbpmi_indicator_types'] = array(
...
FROM "public".lbpmi_indicator_types',
	...
	'fields' => array(
		'indtype_id' => array(
			...
			'goodName' => 'indtype_id',
			'strField' => 'indtype_id',
			'sourceSingle' => 'indtype_id',
			'index' => 1,
			'type' => 3,
			'autoinc' => true,
			'sqlExpression' => 'indtype_id',
			'viewFormats' => array(
				'view' => array(
...
FROM "public".lbpmi_indicator_types',
		...
		'fromList' => array( 
			array(
				'sql' => '"public".lbpmi_indicator_types',
				'parsed' => true,
				'type' => 'FromListItem',
				'table' => array(
					'sql' => '"public".lbpmi_indicator_types',
