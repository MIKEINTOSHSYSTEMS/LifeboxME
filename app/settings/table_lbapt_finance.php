...
$runnerTableSettings['public.lbapt_finance'] = array(
...
FROM "public".lbapt_finance',
	...
	'fields' => array(
		'finance_id' => array(
			...
			'goodName' => 'finance_id',
			'strField' => 'finance_id',
			'sourceSingle' => 'finance_id',
			'index' => 1,
			'type' => 3,
			'autoinc' => true,
			'sqlExpression' => 'finance_id',
			'viewFormats' => array(
				'view' => array(
			...
			'tableName' => 'public.lbapt_finance' 
		),
		'strategic_area_id' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'lookupWhere' => 'strategic_area_id = 9',
					'fileMaxNumber' => 1,
					'fileThumbnailField' => 'th',
					'timeConvention' => 1 
				) 
...
FROM "public".lbapt_finance',
	...
	created_at,
	updated_at',
		'fromListSql' => 'FROM "public".lbapt_finance',
		'orderBySql' => '',
		'tailSql' => '' 
	),
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.lbapt_finance'] = array(
	'tableCaption' => 'Lbapt Finance',
	'fieldLabels' => array(
