...
$runnerTableSettings['public.lbapt_izumi'] = array(
...
FROM "public".lbapt_izumi',
	...
	'fields' => array(
		'izumi_id' => array(
			...
			'goodName' => 'izumi_id',
			'strField' => 'izumi_id',
			'sourceSingle' => 'izumi_id',
			'index' => 1,
			'type' => 3,
			'autoinc' => true,
			'sqlExpression' => 'izumi_id',
			'viewFormats' => array(
				'view' => array(
		...
		'strategic_area_id' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'lookupWhere' => 'strategic_area_id = 14',
					'fileMaxNumber' => 1,
					'fileThumbnailField' => 'th',
					'timeConvention' => 1 
				) 
...
FROM "public".lbapt_izumi',
	...
	created_at,
	updated_at',
		'fromListSql' => 'FROM "public".lbapt_izumi',
		'orderBySql' => '',
		'tailSql' => '' 
	),
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.lbapt_izumi'] = array(
	'tableCaption' => 'Lbapt Izumi',
	'fieldLabels' => array(
		'izumi_id' => 'IZUMI-Id',
