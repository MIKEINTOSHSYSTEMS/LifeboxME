...
$runnerTableSettings['public.lbapt_governance'] = array(
...
FROM "public".lbapt_governance',
	...
	'fields' => array(
		'governance_id' => array(
			'name' => 'governance_id',
			'goodName' => 'governance_id',
			'strField' => 'governance_id',
			'sourceSingle' => 'governance_id',
			'index' => 1,
			'type' => 3,
			'autoinc' => true,
			'sqlExpression' => 'governance_id',
			'viewFormats' => array(
				'view' => array(
			...
			'tableName' => 'public.lbapt_governance' 
		),
		'strategic_area_id' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'lookupWhere' => 'strategic_area_id = 5',
					'fileMaxNumber' => 1,
					'fileThumbnailField' => 'th',
					'timeConvention' => 1 
				) 
...
FROM "public".lbapt_governance',
	...
	created_at,
	updated_at',
		'fromListSql' => 'FROM "public".lbapt_governance',
		'orderBySql' => '',
		'tailSql' => '' 
	),
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.lbapt_governance'] = array(
	'tableCaption' => 'Lbapt Governance',
	'fieldLabels' => array(
