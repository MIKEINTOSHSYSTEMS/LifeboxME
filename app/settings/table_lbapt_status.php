...
$runnerTableSettings['public.lbapt_status'] = array(
...
FROM
	...
	'fields' => array(
		'status_id' => array(
			...
			'tableName' => 'public.lbapt_status' 
		),
		'status_name' => array(
			'name' => 'status_name',
			'goodName' => 'status_name',
			'strField' => 'status_name',
			'sourceSingle' => 'status_name',
			'index' => 2,
		...
		'status_description' => array(
			...
			'sourceSingle' => 'status_description',
			'index' => 3,
			'type' => 201,
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.lbapt_status'] = array(
	'tableCaption' => 'Lbapt Status',
	'fieldLabels' => array(
		'status_id' => 'Status Id',
