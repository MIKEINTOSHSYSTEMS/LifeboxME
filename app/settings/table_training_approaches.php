...
$runnerTableSettings['public.training_approaches'] = array(
	...
	created_at,
	updated_at
FROM "public".training_approaches',
	'keyFields' => array( 
		'approach_id' 
	),
	...
	'fields' => array(
		...
		'approach_name' => array(
			'name' => 'approach_name',
			'goodName' => 'approach_name',
			'strField' => 'approach_name',
			'sourceSingle' => 'approach_name',
			'index' => 2,
			'sqlExpression' => 'approach_name',
			'viewFormats' => array(
				'view' => array(
					'numberFractionalDigits' => 0 
				) 
...
FROM "public".training_approaches',
		...
		'headSql' => 'SELECT',
		'fieldListSql' => 'approach_id,
	approach_name,
	description,
	is_active,
	created_at,
	updated_at',
		'fromListSql' => 'FROM "public".training_approaches',
		'orderBySql' => '',
		'tailSql' => '' 
	),
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.training_approaches'] = array(
	'tableCaption' => 'Training Approaches',
	'fieldLabels' => array(
