...
$runnerTableSettings['public.training_courses'] = array(
...
FROM "public".training_courses',
	...
	'fields' => array(
		...
		'duration_hours' => array(
			'name' => 'duration_hours',
			'goodName' => 'duration_hours',
			'strField' => 'duration_hours',
			'sourceSingle' => 'duration_hours',
			'index' => 4,
			'type' => 3,
			'sqlExpression' => 'duration_hours',
			'viewFormats' => array(
				'view' => array(
					'numberFractionalDigits' => 0 
				) 
...
FROM "public".training_courses',
	...
	created_at,
	updated_at',
		'fromListSql' => 'FROM "public".training_courses',
		'orderBySql' => '',
		'tailSql' => '' 
	),
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.training_courses'] = array(
	'tableCaption' => 'Training Courses',
	'fieldLabels' => array(
		'course_id' => 'Course Id',
