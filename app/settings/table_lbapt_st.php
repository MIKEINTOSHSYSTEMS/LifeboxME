...
$runnerTableSettings['public.lbapt_st'] = array(
		...
		'strategic_area_id' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'lookupWhere' => 'strategic_area_id = 12',
					'fileMaxNumber' => 1,
					'fileThumbnailField' => 'th',
					'timeConvention' => 1 
				) 
...
FROM "public".lbapt_st',
	...
	created_at,
	updated_at',
		'fromListSql' => 'FROM "public".lbapt_st',
		'orderBySql' => '',
		'tailSql' => '' 
	),
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.lbapt_st'] = array(
	'tableCaption' => 'Lbapt St',
	'fieldLabels' => array(
		'st_id' => 'ST Id',
