...
$runnerTableSettings['public.smtp'] = array(
	'name' => 'public.smtp',
	'shortName' => 'smtp',
	'pagesByType' => array(
		'add' => array( 
...
FROM
	...
	'fields' => array(
		...
		'smtpfrom' => array(
			...
			'goodName' => 'smtpfrom',
			'strField' => 'smtpfrom',
			'sourceSingle' => 'smtpfrom',
			'index' => 6,
			'sqlExpression' => 'smtpfrom',
			'viewFormats' => array(
				'view' => array(
					'numberFractionalDigits' => 0 
				) 
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.smtp'] = array(
	'tableCaption' => 'Smtp',
	'fieldLabels' => array(
		'id' => 'Id',
		'username' => 'Username',
