...
$runnerTableSettings['public.lbapt_communications'] = array(
	...
	created_at,
	updated_at
FROM "public".lbapt_communications',
	'keyFields' => array( 
		'communication_id' 
	),
	...
	'fields' => array(
		'communication_id' => array(
			...
			'goodName' => 'communication_id',
			'strField' => 'communication_id',
			'sourceSingle' => 'communication_id',
			'index' => 1,
			'type' => 3,
			'autoinc' => true,
			'sqlExpression' => 'communication_id',
			'viewFormats' => array(
				'view' => array(
			...
			'tableName' => 'public.lbapt_communications' 
		),
		'strategic_area_id' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'lookupWhere' => 'strategic_area_id = 3',
					'fileMaxNumber' => 1,
					'fileThumbnailField' => 'th',
					'timeConvention' => 1 
				) 
		...
		'activity' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'lookupTable' => 'public.lbapt_annual_plan_tracker',
					'lookupTableConnection' => 'lifebox_mesystem_at_localhost',
					'lookupLinkField' => 'activity',
					'lookupDisplayField' => 'activity',
					'lookupAllowAdd' => true,
					'lookupAddPage' => 'add',
					'lookupDependent' => true,
					'lookupDependentFields' => array( 
...
FROM "public".lbapt_communications',
		...
		'fromList' => array( 
			array(
				'sql' => '"public".lbapt_communications',
				'parsed' => true,
				'type' => 'FromListItem',
				'table' => array(
					'sql' => '"public".lbapt_communications',
	...
	created_at,
	updated_at',
		'fromListSql' => 'FROM "public".lbapt_communications',
		'orderBySql' => '',
		'tailSql' => '' 
	),
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.lbapt_communications'] = array(
	'tableCaption' => 'Lbapt Communications',
	'fieldLabels' => array(
