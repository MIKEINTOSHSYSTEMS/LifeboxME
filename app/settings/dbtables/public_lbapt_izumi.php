...
$runnerDbTableInfo['public_lbapt_izumi'] = array(
	'type' => 0,
	'foreignKeys' => array( 
		array(
			'name' => 'lbapt_izumi_status_id_fkey',
			'refSchema' => 'public',
		...
		array(
			'name' => 'lbapt_izumi_strategic_area_id_fkey',
			'refSchema' => 'public',
	...
	'fields' => array( 
		array(
			...
			'type' => 3,
			'autoinc' => true,
			'defaultValueSQL' => 'nextval(\'lbapt_izumi_izumi_id_seq\'::regclass)',
			'defaultValue' => 'nextval(\'lbapt_izumi_izumi_id_seq\'::regclass)',
			'nullable' => false 
		),
		array(
