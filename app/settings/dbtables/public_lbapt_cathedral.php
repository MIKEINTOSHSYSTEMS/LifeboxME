...
$runnerDbTableInfo['public_lbapt_cathedral'] = array(
	'type' => 0,
	'foreignKeys' => array( 
		array(
			'name' => 'lbapt_cathedral_status_id_fkey',
			'refSchema' => 'public',
		...
		array(
			'name' => 'lbapt_cathedral_strategic_area_id_fkey',
			'refSchema' => 'public',
	...
	'fields' => array( 
		array(
			...
			'type' => 3,
			'autoinc' => true,
			'defaultValueSQL' => 'nextval(\'lbapt_cathedral_cathedral_id_seq\'::regclass)',
			'defaultValue' => 'nextval(\'lbapt_cathedral_cathedral_id_seq\'::regclass)',
			'nullable' => false 
		),
		array(
