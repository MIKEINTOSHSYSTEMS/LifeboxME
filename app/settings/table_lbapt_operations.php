...
$runnerTableSettings['public.lbapt_operations'] = array(
...
FROM
	...
	'fields' => array(
		'operation_id' => array(
			'name' => 'operation_id',
			'goodName' => 'operation_id',
			'strField' => 'operation_id',
			'sourceSingle' => 'operation_id',
			'index' => 1,
			'type' => 3,
			'autoinc' => true,
			'sqlExpression' => 'operation_id',
			'viewFormats' => array(
				'view' => array(
			...
			'tableName' => 'public.lbapt_operations' 
		),
		'strategic_area_id' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'lookupWhere' => 'strategic_area_id = 2',
					'fileMaxNumber' => 1,
					'fileThumbnailField' => 'th',
					'timeConvention' => 1 
				) 
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.lbapt_operations'] = array(
	'tableCaption' => 'Lbapt Operations',
	'fieldLabels' => array(
