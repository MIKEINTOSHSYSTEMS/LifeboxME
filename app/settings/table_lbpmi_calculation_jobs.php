...
$runnerTableSettings['public.lbpmi_calculation_jobs'] = array(
...
FROM "public".lbpmi_calculation_jobs',
	...
	'fields' => array(
		'job_id' => array(
			...
			'tableName' => 'public.lbpmi_calculation_jobs' 
		),
		'indicator_id' => array(
			'name' => 'indicator_id',
		...
		'processed_at' => array(
			'name' => 'processed_at',
			'goodName' => 'processed_at',
			'strField' => 'processed_at',
			'sourceSingle' => 'processed_at',
			'index' => 14,
			'type' => 135,
			'sqlExpression' => 'processed_at',
			'viewFormats' => array(
				'view' => array(
					'format' => 'Short Date',
					'numberFractionalDigits' => 0 
		...
		'attempts' => array(
			...
			'goodName' => 'attempts',
			'strField' => 'attempts',
			'sourceSingle' => 'attempts',
			'index' => 16,
			'type' => 3,
			'sqlExpression' => 'attempts',
			'viewFormats' => array(
				'view' => array(
					'numberFractionalDigits' => 0 
				) 
		...
		'next_retry' => array(
			...
			'goodName' => 'next_retry',
			'strField' => 'next_retry',
			'sourceSingle' => 'next_retry',
			'index' => 17,
			'type' => 135,
			'sqlExpression' => 'next_retry',
			'viewFormats' => array(
				'view' => array(
					'format' => 'Short Date',
					'numberFractionalDigits' => 0 
...
FROM "public".lbpmi_calculation_jobs',
		...
		'fieldList' => array( 
			...
			array(
				...
				'encrypted' => false,
				'columnName' => 'next_retry' 
			) 
		),
		'fromList' => array( 
			array(
				'sql' => '"public".lbpmi_calculation_jobs',
				'parsed' => true,
				'type' => 'FromListItem',
				'table' => array(
					'sql' => '"public".lbpmi_calculation_jobs',
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.lbpmi_calculation_jobs'] = array(
	'tableCaption' => 'Lbpmi Calculation Jobs',
	'fieldLabels' => array(
		'job_id' => 'Job Id',
