...
$runnerTableSettings['public.procedures'] = array(
...
FROM
	...
	'fields' => array(
		...
		'procedure_category' => array(
			...
			'goodName' => 'procedure_category',
			'strField' => 'procedure_category',
			'sourceSingle' => 'procedure_category',
			'index' => 3,
			'sqlExpression' => 'procedure_category',
			'viewFormats' => array(
				'view' => array(
					'numberFractionalDigits' => 0 
				) 
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.procedures'] = array(
	'tableCaption' => 'Procedures',
	'fieldLabels' => array(
