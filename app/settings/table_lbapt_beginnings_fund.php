...
$runnerTableSettings['public.lbapt_beginnings_fund'] = array(
...
FROM
	...
	'fields' => array(
		'bf_id' => array(
			...
			'tableName' => 'public.lbapt_beginnings_fund' 
		),
		'strategic_area_id' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'lookupWhere' => 'strategic_area_id = 8',
					'fileMaxNumber' => 1,
					'fileThumbnailField' => 'th',
					'timeConvention' => 1 
				) 
...
FROM
	"public".lbapt_beginnings_fund',
		...
		'fromList' => array( 
			array(
				'sql' => '"public".lbapt_beginnings_fund',
				'parsed' => true,
				'type' => 'FromListItem',
				'table' => array(
					'sql' => '"public".lbapt_beginnings_fund',
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.lbapt_beginnings_fund'] = array(
	'tableCaption' => 'Lbapt Beginnings Fund',
	'fieldLabels' => array(
		'bf_id' => 'BF ID',
