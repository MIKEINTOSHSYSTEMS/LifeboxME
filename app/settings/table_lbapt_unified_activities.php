...
$runnerTableSettings['public.lbapt_unified_activities'] = array(
...
FROM
	...
	'fields' => array(
		'strategic_area_id' => array(
			...
			'tableName' => 'public.lbapt_unified_activities' 
		),
		'activity_id' => array(
			'name' => 'activity_id',
			'goodName' => 'activity_id',
			'strField' => 'activity_id',
			'sourceSingle' => 'activity_id',
			'index' => 2,
			'type' => 3,
			'sqlExpression' => 'activity_id',
			'viewFormats' => array(
				'view' => array(
					'numberFractionalDigits' => 0 
				) 
		...
		'activity_type' => array(
			'name' => 'activity_type',
			'goodName' => 'activity_type',
			'strField' => 'activity_type',
			'sourceSingle' => 'activity_type',
			'index' => 3,
			'type' => 201,
			'sqlExpression' => 'activity_type',
			'viewFormats' => array(
				'view' => array(
					'numberFractionalDigits' => 0 
				) 
...
FROM
	"public".lbapt_unified_activities',
		...
		'fromList' => array( 
			array(
				'sql' => '"public".lbapt_unified_activities',
				'parsed' => true,
				'type' => 'FromListItem',
				'table' => array(
					'sql' => '"public".lbapt_unified_activities',
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.lbapt_unified_activities'] = array(
	'tableCaption' => 'Lbapt Unified Activities',
	'fieldLabels' => array(
