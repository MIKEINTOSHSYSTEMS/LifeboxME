...
$runnerTableSettings['public.lbapt_hr'] = array(
		...
		'strategic_area_id' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'lookupWhere' => 'strategic_area_id = 10',
					'fileMaxNumber' => 1,
					'fileThumbnailField' => 'th',
					'timeConvention' => 1 
				) 
...
FROM "public".lbapt_hr',
	...
	created_at,
	updated_at',
		'fromListSql' => 'FROM "public".lbapt_hr',
		'orderBySql' => '',
		'tailSql' => '' 
	),
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.lbapt_hr'] = array(
	'tableCaption' => 'Lbapt Hr',
	'fieldLabels' => array(
		'hr_id' => 'HR ID',
