...
$runnerTableSettings['public.lbapt_cathedral'] = array(
...
FROM "public".lbapt_cathedral',
	...
	'fields' => array(
		'cathedral_id' => array(
			'name' => 'cathedral_id',
			'goodName' => 'cathedral_id',
			'strField' => 'cathedral_id',
			'sourceSingle' => 'cathedral_id',
			'index' => 1,
			'type' => 3,
			'autoinc' => true,
			'sqlExpression' => 'cathedral_id',
			'viewFormats' => array(
				'view' => array(
			...
			'tableName' => 'public.lbapt_cathedral' 
		),
		'strategic_area_id' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'lookupWhere' => 'strategic_area_id = 11',
					'fileMaxNumber' => 1,
					'fileThumbnailField' => 'th',
					'timeConvention' => 1 
				) 
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.lbapt_cathedral'] = array(
	'tableCaption' => 'Lbapt Cathedral',
	'fieldLabels' => array(
		'cathedral_id' => 'CathID',
