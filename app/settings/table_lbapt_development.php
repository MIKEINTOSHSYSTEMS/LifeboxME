...
$runnerTableSettings['public.lbapt_development'] = array(
...
FROM "public".lbapt_development',
	...
	'fields' => array(
		'development_id' => array(
			'name' => 'development_id',
			'goodName' => 'development_id',
			'strField' => 'development_id',
			'sourceSingle' => 'development_id',
			'index' => 1,
			'type' => 3,
			'autoinc' => true,
			'sqlExpression' => 'development_id',
			'viewFormats' => array(
				'view' => array(
			...
			'tableName' => 'public.lbapt_development' 
		),
		'strategic_area_id' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'lookupWhere' => 'strategic_area_id = 4',
					'fileMaxNumber' => 1,
					'fileThumbnailField' => 'th',
					'timeConvention' => 1 
				) 
...
FROM "public".lbapt_development',
	...
	created_at,
	updated_at',
		'fromListSql' => 'FROM "public".lbapt_development',
		'orderBySql' => '',
		'tailSql' => '' 
	),
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.lbapt_development'] = array(
	'tableCaption' => 'Lbapt Development',
	'fieldLabels' => array(
