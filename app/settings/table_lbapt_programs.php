...
$runnerTableSettings['public.lbapt_programs'] = array(
...
FROM "public".lbapt_programs',
	...
	'fields' => array(
		'program_id' => array(
			...
			'tableName' => 'public.lbapt_programs' 
		),
		'strategic_area_id' => array(
			...
			'editFormats' => array(
				'edit' => array(
					...
					'lookupWhere' => 'strategic_area_id = 1',
					'fileMaxNumber' => 1,
					'fileThumbnailField' => 'th',
					'timeConvention' => 1 
				) 
...
FROM "public".lbapt_programs',
	...
	created_at,
	updated_at',
		'fromListSql' => 'FROM "public".lbapt_programs',
		'orderBySql' => '',
		'tailSql' => '' 
	),
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.lbapt_programs'] = array(
	'tableCaption' => 'Lbapt Programs',
	'fieldLabels' => array(
