...
$runnerTableSettings['public.lbapt_kpis_on_track'] = array(
...
FROM
	...
	'fields' => array(
		'kpi_id' => array(
			...
			'tableName' => 'public.lbapt_kpis_on_track' 
		),
...
FROM
	"public".lbapt_kpis_on_track',
		...
		'fromList' => array( 
			array(
				'sql' => '"public".lbapt_kpis_on_track',
				'parsed' => true,
				'type' => 'FromListItem',
				'table' => array(
					'sql' => '"public".lbapt_kpis_on_track',
...
if( mlang_getcurrentlang() === 'English' ) {
	$runnerTableLabels['public.lbapt_kpis_on_track'] = array(
	'tableCaption' => 'Lbapt Kpis On Track',
	'fieldLabels' => array(
		'kpi_id' => 'KPI ID',
