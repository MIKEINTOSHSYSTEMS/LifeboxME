...
require_once("include/clean_cut_implementations_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.clean_cut_implementations" );
