...
require_once("include/lifeboxme_dhis2_analytics_data_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.lifeboxme_dhis2_analytics_data" );
