...
require_once("include/device_inventory_changes_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.device_inventory_changes" );
