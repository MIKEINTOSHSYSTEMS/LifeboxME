...
require_once("include/lbpmi_calculation_log_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.lbpmi_calculation_log" );
