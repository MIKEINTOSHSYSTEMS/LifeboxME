<?php
class eventclass_lbpmi_datasets  extends TableEventsBase {
...
$values["dataset_code"] = gen_random_string(); 

// $values["dataset_code"] = implode('-', str_split(gen_random_string(), 5));
...
// $values["dataset_code"] = implode('-', str_split(gen_random_string(), 5)); // NOT WORKING we do not want it as it does not match DHIS2's scheme
