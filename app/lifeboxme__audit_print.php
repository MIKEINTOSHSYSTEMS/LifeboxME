...
require_once("include/lifeboxme__audit_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.lifeboxme__audit" );
