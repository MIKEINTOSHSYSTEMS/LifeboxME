...
require_once("include/participant_attendance_summary_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.participant_attendance_summary" );
