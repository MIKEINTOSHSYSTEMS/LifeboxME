...
$dalTabletraining_participants["training_id"] = array("type"=>3,"varname"=>"training_id", "name" => "training_id", "autoInc" => "0");
...
$dalTabletraining_participants["day_number"] = array("type"=>3,"varname"=>"day_number", "name" => "day_number", "autoInc" => "0");
