<?php
$dalTabletraining_types = array();
$dalTabletraining_types["training_type_id"] = array("type"=>3,"varname"=>"training_type_id", "name" => "training_type_id", "autoInc" => "1");
$dalTabletraining_types["type_name"] = array("type"=>200,"varname"=>"type_name", "name" => "type_name", "autoInc" => "0");
$dalTabletraining_types["description"] = array("type"=>201,"varname"=>"description", "name" => "description", "autoInc" => "0");
