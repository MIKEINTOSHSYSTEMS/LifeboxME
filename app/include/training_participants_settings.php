...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelstraining_participants["English"]["title_salutation"] = "Title/Salutation";
	$fieldToolTipstraining_participants["English"]["title_salutation"] = "";
	$placeHolderstraining_participants["English"]["title_salutation"] = "";
...
$tdatatraining_participants[".googleLikeFields"][] = "title_salutation";
...
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 2;
	$fdata["strName"] = "title_salutation";
	$fdata["GoodName"] = "title_salutation";
	$fdata["ownerTable"] = "public.training_participants";
	$fdata["Label"] = GetFieldLabel("public_training_participants","title_salutation");
	$fdata["FieldType"] = 200;
		...
		$fdata["strField"] = "title_salutation";

		$fdata["sourceSingle"] = "title_salutation";

	
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "title_salutation";
...
//end of Filters settings
	...
	$tdatatraining_participants["title_salutation"] = $fdata;
		$tdatatraining_participants[".searchableFields"][] = "title_salutation";
//	first_name
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 3;
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "public.training_participants";
	$fdata["Label"] = GetFieldLabel("public_training_participants","middle_name");
	$fdata["FieldType"] = 200;
...
$masterTablesData["public.training_participants"] = array();
	...
	$masterTablesData["public.training_participants"][2]["masterKeys"][]="facility_id";
				$masterTablesData["public.training_participants"][2]["detailKeys"] = array();
	$masterTablesData["public.training_participants"][2]["detailKeys"][]="facility_id";
	...
	$masterTablesData["public.training_participants"][3]["masterKeys"][]="country_id";
				$masterTablesData["public.training_participants"][3]["detailKeys"] = array();
	$masterTablesData["public.training_participants"][3]["detailKeys"][]="country_id";
	...
	$masterTablesData["public.training_participants"][4]["masterKeys"][]="venue_id";
				$masterTablesData["public.training_participants"][4]["detailKeys"] = array();
	$masterTablesData["public.training_participants"][4]["detailKeys"][]="venue_id";
...
$proto0["m_fieldlist"][]=$obj;
						$proto8=array();
			$obj = new SQLField(array(
	"m_strName" => "title_salutation",
	"m_strTable" => "public.training_participants",
	"m_srcTableName" => "public.training_participants"
));

$proto8["m_sql"] = "title_salutation";
