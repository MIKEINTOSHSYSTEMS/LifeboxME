...
class tDAL
{
	...
	var $tbllifebox_mesystem_at_localhost_public_lbapt_cathedral;
	...
	var $tbllifebox_mesystem_at_localhost_public_lbapt_izumi;
	...
	var $tbllifebox_mesystem_at_localhost_public_lbapt_st;
	...
	var $tbllifebox_mesystem_at_localhost_public_lbpmi_aggregation_type;
	...
	var $tbllifebox_mesystem_at_localhost_public_lbpmi_data_values;
	var $tbllifebox_mesystem_at_localhost_public_lbpmi_datasets;
	var $tbllifebox_mesystem_at_localhost_public_lbpmi_domain_type;
	var $tbllifebox_mesystem_at_localhost_public_lbpmi_indicator_actuals;
	var $tbllifebox_mesystem_at_localhost_public_lbpmi_indicator_groups;
	var $tbllifebox_mesystem_at_localhost_public_lbpmi_indicator_targets;
	var $tbllifebox_mesystem_at_localhost_public_lbpmi_indicator_types;
	var $tbllifebox_mesystem_at_localhost_public_lbpmi_indicators;
	var $tbllifebox_mesystem_at_localhost_public_lbpmi_summary;
	...
	var $tbllifebox_mesystem_at_localhost_public_period_types;
	...
	var $tbllifebox_mesystem_at_localhost_public_unit_of_measurement;
	...
	function FillTablesList()
	{
		...
		$this->lstTables[] = array("name" => "lbapt_cathedral", "varname" => "lifebox_mesystem_at_localhost_public_lbapt_cathedral", "altvarname" => "lbapt_cathedral", "connId" => "lifebox_mesystem_at_localhost", "schema" => "public", "connName" => "lifebox_mesystem at localhost");
		...
		$this->lstTables[] = array("name" => "lbapt_izumi", "varname" => "lifebox_mesystem_at_localhost_public_lbapt_izumi", "altvarname" => "lbapt_izumi", "connId" => "lifebox_mesystem_at_localhost", "schema" => "public", "connName" => "lifebox_mesystem at localhost");
		...
		$this->lstTables[] = array("name" => "lbapt_st", "varname" => "lifebox_mesystem_at_localhost_public_lbapt_st", "altvarname" => "lbapt_st", "connId" => "lifebox_mesystem_at_localhost", "schema" => "public", "connName" => "lifebox_mesystem at localhost");
		...
		$this->lstTables[] = array("name" => "lbpmi_aggregation_type", "varname" => "lifebox_mesystem_at_localhost_public_lbpmi_aggregation_type", "altvarname" => "lbpmi_aggregation_type", "connId" => "lifebox_mesystem_at_localhost", "schema" => "public", "connName" => "lifebox_mesystem at localhost");
		...
		$this->lstTables[] = array("name" => "lbpmi_data_values", "varname" => "lifebox_mesystem_at_localhost_public_lbpmi_data_values", "altvarname" => "lbpmi_data_values", "connId" => "lifebox_mesystem_at_localhost", "schema" => "public", "connName" => "lifebox_mesystem at localhost");
		...
		$this->lstTables[] = array("name" => "lbpmi_domain_type", "varname" => "lifebox_mesystem_at_localhost_public_lbpmi_domain_type", "altvarname" => "lbpmi_domain_type", "connId" => "lifebox_mesystem_at_localhost", "schema" => "public", "connName" => "lifebox_mesystem at localhost");
		$this->lstTables[] = array("name" => "lbpmi_indicator_actuals", "varname" => "lifebox_mesystem_at_localhost_public_lbpmi_indicator_actuals", "altvarname" => "lbpmi_indicator_actuals", "connId" => "lifebox_mesystem_at_localhost", "schema" => "public", "connName" => "lifebox_mesystem at localhost");
		$this->lstTables[] = array("name" => "lbpmi_indicator_groups", "varname" => "lifebox_mesystem_at_localhost_public_lbpmi_indicator_groups", "altvarname" => "lbpmi_indicator_groups", "connId" => "lifebox_mesystem_at_localhost", "schema" => "public", "connName" => "lifebox_mesystem at localhost");
		$this->lstTables[] = array("name" => "lbpmi_indicator_targets", "varname" => "lifebox_mesystem_at_localhost_public_lbpmi_indicator_targets", "altvarname" => "lbpmi_indicator_targets", "connId" => "lifebox_mesystem_at_localhost", "schema" => "public", "connName" => "lifebox_mesystem at localhost");
		$this->lstTables[] = array("name" => "lbpmi_indicator_types", "varname" => "lifebox_mesystem_at_localhost_public_lbpmi_indicator_types", "altvarname" => "lbpmi_indicator_types", "connId" => "lifebox_mesystem_at_localhost", "schema" => "public", "connName" => "lifebox_mesystem at localhost");
		$this->lstTables[] = array("name" => "lbpmi_indicators", "varname" => "lifebox_mesystem_at_localhost_public_lbpmi_indicators", "altvarname" => "lbpmi_indicators", "connId" => "lifebox_mesystem_at_localhost", "schema" => "public", "connName" => "lifebox_mesystem at localhost");
		$this->lstTables[] = array("name" => "lbpmi_summary", "varname" => "lifebox_mesystem_at_localhost_public_lbpmi_summary", "altvarname" => "lbpmi_summary", "connId" => "lifebox_mesystem_at_localhost", "schema" => "public", "connName" => "lifebox_mesystem at localhost");
		...
		$this->lstTables[] = array("name" => "period_types", "varname" => "lifebox_mesystem_at_localhost_public_period_types", "altvarname" => "period_types", "connId" => "lifebox_mesystem_at_localhost", "schema" => "public", "connName" => "lifebox_mesystem at localhost");
		...
		$this->lstTables[] = array("name" => "unit_of_measurement", "varname" => "lifebox_mesystem_at_localhost_public_unit_of_measurement", "altvarname" => "unit_of_measurement", "connId" => "lifebox_mesystem_at_localhost", "schema" => "public", "connName" => "lifebox_mesystem at localhost");
