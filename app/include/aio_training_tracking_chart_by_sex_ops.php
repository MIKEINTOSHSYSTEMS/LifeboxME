<?php
$topsaio_training_tracking_chart_by_sex = array();
		$topsaio_training_tracking_chart_by_sex["selectList"] = array(
		"subtype" => "sql",
		"sql" => "SELECT
...
ORDER BY
  ...
  ts.\"start_date\";",
		...
		$tables_data["aio_training_tracking Chart by sex"][".operations"] = &$topsaio_training_tracking_chart_by_sex;
?>