<?php
			...
			'grid' => array(
				'cells' => array(
					...
					'headcell_field5' => array(
						...
						'tags' => array( 
							'display_property_fieldheadercolumn' 
						),
						'items' => array( 
							'simple_grid_field18' 
						),
					...
					'headcell_field6' => array(
						...
						'tags' => array( 
							'include_num_den_fieldheadercolumn' 
						),
						'items' => array( 
							'simple_grid_field19' 
						),
	...
	'items' => array(
		...
		'text' => array(
			'type' => 'text',
			'label' => array(
				'text' => '<iframe src="/api/dhis2/analytics/fetch_analytics.php"    style="width: 100%; height: 200vh; border: none;"    title="DHIS2 Analytics Settings"></iframe><style>    iframe {        max-width: 100%;        min-width: 320px;        /* Minimum width for mobile devices */        height: 80vh;        /* Adjust height as per your needs */    }    @media (max-width: 600px) {        iframe {            height: 60vh;            /* Adjust for smaller screens */        }    }    @media (min-width: 600px) {        iframe {            height: 80vh;            /* Adjust for larger screens */        }    }</style>',
				'type' => 0 
			),
			'editedByRte' => false 
		),
