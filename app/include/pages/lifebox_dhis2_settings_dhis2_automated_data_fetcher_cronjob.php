...
'dataGrid' => array( 'groupFields' => array(  ) ) );
			$pageArray = array( 'id' => 'dhis2_automated_data_fetcher_cronjob',
'type' => 'list',
'layoutId' => 'leftbar',
'disabled' => 0,
'default' => 0,
...
'label' => array( 'text' => '<iframe src="/api/job/cronjobs.php" style="width: 100%; height: 200vh; border: none;" title="DHIS2 Analytics Automated Cron Job Settings"></iframe>
<style>
    iframe {
        max-width: 100%;
        min-width: 320px;
