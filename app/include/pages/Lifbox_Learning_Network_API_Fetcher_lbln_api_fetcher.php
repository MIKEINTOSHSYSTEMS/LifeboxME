<?php
	...
	'items' => array(
		...
		'text' => array(
			'type' => 'text',
			'label' => array(
				'text' => '<iframe src="/api/lbln/fetch_courses.php"    style="width: 100%; height: 200vh; border: none;"    title="Lifebox Learning Network API Data Fetcher"></iframe><style>    iframe {        max-width: 100%;        min-width: 320px;        /* Minimum width for mobile devices */        height: 80vh;        /* Adjust height as per your needs */    }    @media (max-width: 600px) {        iframe {            height: 60vh;            /* Adjust for smaller screens */        }    }    @media (min-width: 600px) {        iframe {            height: 80vh;            /* Adjust for larger screens */        }    }</style>',
				'type' => 0 
			),
			'editedByRte' => false 
		),
...
">
	...
	<iframe src="/api/lbln/fetch_courses.php"    style="width: 100%; height: 200vh; border: none;"    title="Lifebox Learning Network API Data Fetcher"></iframe><style>    iframe {        max-width: 100%;        min-width: 320px;        /* Minimum width for mobile devices */        height: 80vh;        /* Adjust height as per your needs */    }    @media (max-width: 600px) {        iframe {            height: 60vh;            /* Adjust for smaller screens */        }    }    @media (min-width: 600px) {        iframe {            height: 80vh;            /* Adjust for larger screens */        }    }</style></span>
		</div>					</div>
			</div>		
