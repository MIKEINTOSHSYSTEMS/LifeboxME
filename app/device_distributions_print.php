...
require_once("include/device_distributions_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.device_distributions" );
