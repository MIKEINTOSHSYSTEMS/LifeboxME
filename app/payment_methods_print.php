...
require_once("include/payment_methods_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.payment_methods" );
