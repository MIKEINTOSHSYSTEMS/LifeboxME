...
require_once("include/lbapt_annual_plan_tracker_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.lbapt_annual_plan_tracker" );
