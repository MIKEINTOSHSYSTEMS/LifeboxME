...
require_once("include/device_distribution_summary_view_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.device_distribution_summary_view" );
