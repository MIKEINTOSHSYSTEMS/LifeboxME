...
require_once("include/lifebox_dhis2_dataitems_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Lifebox_DHIS2_dataItems" );
