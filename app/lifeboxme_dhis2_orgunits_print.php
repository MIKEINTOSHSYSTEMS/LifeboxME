...
require_once("include/lifeboxme_dhis2_orgunits_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.lifeboxme_dhis2_orgunits" );
